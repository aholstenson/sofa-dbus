...
public class Hex {
     ...
     * @throws IOException Thrown if an odd number or illegal of characters 
     *         is supplied
     */
    ...
    protected static int toDigit(char ch, int index) throws IOException {
        ...
        if (digit == -1) {
            throw new IOException("Illegal hexadecimal charcter " + ch + " at index " + index);
        }
        return digit;
    }
     ...
     * @throws IOException Thrown if an odd number of characters is supplied
     *                   to this function
     * @see #decodeHex(char[])
     */
	public byte[] decode(byte[] array) throws IOException {
